      ...
      <main className={styles.pageContainer}>
        ...
        >
          ...
          <motion.div className={styles.headingContainer}>
            ...
            <motion.h1 className={styles.heading} variants={headingVariants}>CONTACT US</motion.h1>
          </motion.div>

          {/* Subheading */}
          <motion.p className={styles.subHeading} variants={headingVariants}>
